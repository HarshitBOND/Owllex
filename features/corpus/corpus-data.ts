export const accentStyles: Record<string, { color: string; bgColor: string }> = {
  ...
  emerald: { color: "text-brand-700 dark:text-brand-400", bgColor: "bg-brand-50 dark:bg-brand-500/10" },
}
...
export const statusStyles: Record<string, { label: string; color: string; bgColor: string }> = {
  ...
  ready: { label: "Indexed", color: "text-brand-700 dark:text-brand-400", bgColor: "bg-brand-50 dark:bg-brand-500/10" },
