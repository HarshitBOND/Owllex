...
import VaultHome from "@/features/vault/components/VaultHome"
    ...
    <div className="flex">
      ...
      >
        <div className="px-3 sm:px-4 md:px-6 pt-3 md:pt-4">
          <Navbar
            location="Vault"
            subtitle="Every document you've uploaded, stored securely and sealed with a SHA-256 fingerprint."
          />
        </div>
