...
import CorpusHome from "@/features/corpus/components/CorpusHome"
    ...
    <div className="flex">
      ...
      >
        <div className="px-3 sm:px-4 md:px-6 pt-3 md:pt-4">
          <Navbar
            location="Corpus"
            subtitle="A workspace per matter. Describe it once and every chat, draft and workflow knows the file."
          />
        </div>
